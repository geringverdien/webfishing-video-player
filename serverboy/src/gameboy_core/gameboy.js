...
GameBoyCore.prototype.outputAudio = function () {
    ...
    //this.channelFrequencies = [[this.channel1currentSampleLeftTrimary, this.channel1frequency], [this.channel2currentSampleLeftTrimary, this.channel2frequency], [this.channel3currentSampleLeftSecondary, this.channel3frequency], [this.channel4currentSampleLeftSecondary, this.channel4FrequencyPeriod]];
    this.channelFrequencies = [[this.channel1Enabled ? 1:0, this.channel1frequency], [this.channel2Enabled ? 1:0, this.channel2frequency], [this.channel3Enabled ? 1:0, this.channel3frequency]];
